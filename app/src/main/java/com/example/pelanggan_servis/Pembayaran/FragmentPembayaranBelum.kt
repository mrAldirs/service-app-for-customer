...
class FragmentPembayaranBelum : Fragment() {
    ...
    override fun onCreateView(
        ...
        v.textJudul.setText("Pembayaran Belum Selesai")
        ...
        showDataPembayaran("show_data_pembayaran_belum")
    ...
    private fun showDataPembayaran(mode: String) {
        val request = object : StringRequest(
            ...
            override fun getParams(): MutableMap<String, String>? {
                ...
                when(mode){
                    "show_data_pembayaran_belum" -> {
                        hm.put("mode","show_data_pembayaran_belum")
