...
import com.example.pelanggan_servis.databinding.ProfilLayananActivityBinding

class LayananProfilActivity : AppCompatActivity() {
    private lateinit var b: ProfilLayananActivityBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        b = ProfilLayananActivityBinding.inflate(layoutInflater)
